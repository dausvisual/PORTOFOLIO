...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: {
      canonical: `https://firdausikram.xyz/galeri/${id}`,
    },
    openGraph: {
      title: `${project.title} | Portofolio Firdaus Ikram`,
      description: project.desc,
      ...
      images: [
        {
          url: project.images[0] || 'https://firdausikram.xyz/logo/thumbnail-new.jpg',
          width: 1200,
          height: 630,
    ...
    twitter: {
      ...
      title: `${project.title} | Portofolio Firdaus Ikram`,
      description: project.desc,
      images: [project.images[0] || 'https://firdausikram.xyz/logo/thumbnail-new.jpg'],
    },
  };
}
