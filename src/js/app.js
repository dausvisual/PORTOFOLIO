...
if (document.getElementById('particles-js')) {
    particlesJS("particles-js", {
      "particles": {
        "number": {
          "value": 60,             // Jumlah debu/node spasial (jangan terlalu banyak agar tidak berat)
          "density": { "enable": true, "value_area": 800 }
        },
        "color": {
          "value": ["#00e5ff", "#4f46e5", "#ffffff"] // Tinta Biru Neon (Cyan), Ungu Indigo, Putih
        },
        "shape": { "type": "circle" },
        "opacity": {
          "value": 0.6,            // Sedikit lebih terang agar terlihat futuristik
          "random": true,          
        ...
        "line_linked": {
          "enable": true,          // Mengaktifkan garis jaring (Fiber Optik)
          "distance": 150,         // Jarak jangkauan benang antar node
          "color": "#00e5ff",      // Warna garis jaring Cyan menyala
          "opacity": 0.3,          // Kebeningan garis
      ...
      "interactivity": {
        "detect_on": "canvas",
        "events": {
          "onhover": { "enable": true, "mode": "grab" }, // Garis menempel ke kursor mouse bak magnet
          "onclick": { "enable": true, "mode": "push" }, // Memunculkan node baru saat diklik
          "resize": true
        },
        "modes": {
          "grab": { 
             "distance": 180, 
             "line_linked": { "opacity": 0.8 } // Tali ke kursor jadi sangat terang saat ditangkap
          },
          "push": { "particles_nb": 3 }
        }
      },
